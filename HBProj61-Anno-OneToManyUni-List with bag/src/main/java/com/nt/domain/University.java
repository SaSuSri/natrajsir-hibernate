...
/*create table University2(unid number(5) primary key,
                                   name varchar2(20),region varchar2(20));
 create table College2(cid number(5) primary key,name varchar2(20),
            location varchar2(20),
             affiliatedTo number(6) references University2(unid));
